...
[ApiController]
[Route("cities")]
public class CityController: ControllerBase, IController<CityEntity, int>
{
    private readonly IService<CityEntity, int> _service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CityEntity item)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] CityEntity item)
    {
