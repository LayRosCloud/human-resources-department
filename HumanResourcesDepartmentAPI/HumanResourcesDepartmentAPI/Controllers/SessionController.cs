...
[ApiController]
[Route("sessions")]
public class SessionController: ControllerBase, IController<SessionEntity, int>
{
    private readonly IService<SessionEntity, int> _service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] SessionEntity item)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] SessionEntity item)
    {
