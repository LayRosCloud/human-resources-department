...
[ApiController]
[Route("phones")]
public class PhoneController: ControllerBase, IController<PhoneEntity, int>
{
    private readonly IService<PhoneEntity, int> _service;

    public PhoneController()
    {
        _service = new PhoneService();
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] PhoneEntity item)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] PhoneEntity item)
    {
